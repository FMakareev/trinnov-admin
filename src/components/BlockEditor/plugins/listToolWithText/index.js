...
export class ListToolWithText {
  ...
  render() {
    ...
    this._elements.container = this._make('div');


    this._elements.header = new Header({
      data: {
        text: this._data.header,
        level: 4,
      },
      api: this.api,
      config: {
    ...
    this._elements.container.appendChild( this._elements.header._element);
    this._elements.container.appendChild(this._elements.wrapper);
  ...
  get data() {
    ...
    this._data.header = this._elements.header._element.innerHTML;
